...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // front face culling can reduce peter-panning but if not handled correctly it can cause objects that lack a fully enclosed inside 
        // like the floor to be completely culled
        ...
        //glCullFace(GL_BACK); // reset culling to normal behavior
        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);

        // second pass: render scene with shadows and blinn-phong 
        shadowShader.use();
        ...
        shadowShader.setInt("shadowMapFilterSize", 3); // set size of shadow filter - 3 will be 3x3 filter
