...
int main()
{
    ...
    // load textures
    // -------------
    unsigned int floorDiffuse = loadTexture("../../../textures/bricks2.jpg");
    unsigned int floorNormal = loadTexture("../../../textures/bricks2_normal.jpg");
    unsigned int floorDisplacement = loadTexture("../../../textures/bricks2_disp.jpg");
