...
int main()
{
    ...
    // the locations of the leafy greens
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE); // can be used to stop interpolation of values on border of texture to stop the white bit at the top of the texture
