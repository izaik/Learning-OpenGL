...
int main()
{
    ...
    // -------------------------
    Shader gPassShader("gPass.vert", "gPass.frag");
    ...
    // check if framebuffer is complete and print warning if not
    ...
    // load model
    // -------------
    Model ourModel("C:/Users/isaac/Desktop/Learn OpenGL/backpack/backpack.obj");
    std::vector<glm::vec3> objPositions;
    objPositions.push_back(glm::vec3(-3.0, -0.5, -3.0));
    objPositions.push_back(glm::vec3(0.0, -0.5, -3.0));
    objPositions.push_back(glm::vec3(3.0, -0.5, -3.0));
    objPositions.push_back(glm::vec3(-3.0, -0.5, 0.0));
    objPositions.push_back(glm::vec3(0.0, -0.5, 0.0));
    objPositions.push_back(glm::vec3(3.0, -0.5, 0.0));
    objPositions.push_back(glm::vec3(-3.0, -0.5, 3.0));
    objPositions.push_back(glm::vec3(0.0, -0.5, 3.0));
    objPositions.push_back(glm::vec3(3.0, -0.5, 3.0));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 1st pass - render geometry to the gbuffer
        // ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
        glBindFramebuffer(GL_FRAMEBUFFER, gBuffer);
            glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
            ...
            for (unsigned int i = 0; i < objPositions.size(); i++)
            {
                model = glm::mat4(1.0f);
                model = glm::translate(model, objPositions[i]);
                model = glm::scale(model, glm::vec3(0.5f));
                gPassShader.setMat4("model", model);
                ourModel.Draw(gPassShader);
            }
        glBindFramebuffer(GL_FRAMEBUFFER, 0);

        // 2nd pass - calculate lighting be iterating over screen-sized quad containing the gbuffer data
        // ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
        ...
        // render lightcubes with forward rendering
